function Plot_Surf(f,point)
    ...
    plot3(point(1),point(2),f(point(1),point(2)),'r*','LineWidth',2,'MarkerSize',10) % plot de un punto cualqueira en 3D
    ...
    plot(point(1),point(2),'r*','LineWidth',2,'MarkerSize',10) % plot de un punto cualqueira en 2D
    legend({'función','óptimo'},'FontSize',15)
